...
class GatewayInboundMixin:
    ...
    async def _hm_cmd_start(self, event, source, _quick_key):
        bot_name = os.getenv("TELEGRAM_BOT_NAME") or os.getenv("HERMES_AGENT_NAME") or "Hermes"
        logger.info("Handling /start greeting for session %s (bot: %s)", _quick_key, bot_name)
        if "trollbox" in bot_name.lower():
            return True, f"🤖 Hello! I am @{bot_name}, your Trollbox agent.\n\nI am online and connected to the Trollbox MCP service (stats, mining, chat) and Safex tools.\n\nHow can I help you today?"
        if "ha" in bot_name.lower() or "magnolia" in bot_name.lower():
            return True, f"🌿 Hello! I am @{bot_name}, your Home Assistant AI assistant. I am online and connected to your smart home. How can I help you today?"
        return True, f"👋 Hello! I am @{bot_name}, your Hermes Fleet agent. I am online and ready to help. How can I assist you today?"
