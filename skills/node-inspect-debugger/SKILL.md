...
node --inspect=127.0.0.1:9230 script.js   # custom host:port
```
...
7. **Security.** `--inspect=127.0.0.1:9229` exposes arbitrary code execution. Always bind to `127.0.0.1` (the default) unless you have an isolated network.
